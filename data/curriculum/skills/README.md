...
- `g4.json` … `g8.json`：每年级一个文件（G8 于 2026-09-02 加入），`topics[]`（主题 = 导航分组）+ `skills[]`（技能 = 教/练/诊/记的最小单位）。schema `yy-skills/1`，字段说明见设计文档 §3.4。
...
有技能文件的年级（G4–G8）选年级即技能视图。讲课（微课提示词）、闯关（误区标签）、
